import unittest
from App import select_chart_type,  select_time_series, select_beginning_end_dates, 
import datetime

class TestAppInputs(unittest.TestCase):
    
    def test_stock_symbol(self):
    #test for valid and invalid stock symbols
